...
def generateMAL(out_excel, county, rate=10.0, year=2015, where_clause='', sort_by=DEFAULT_SORT):
    ...
    if county.upper() in ALL_OR_NOTHING_COUNTIES:
        return generateMAL_AON(out_excel, county, rate, year, where_clause, sort_by)
    else:
        return generateMAL_TOP(out_excel, county, rate, year, where_clause, sort_by)

##@utils.timeit
def generateMAL_AON(out_excel, county, rate=10.0, year=2015, where_clause='', sort_by=DEFAULT_SORT):
...
def generateMAL_TOP(out_excel, county, rate=10.0, year=2015, where_clause='', sort_by=DEFAULT_SORT):
